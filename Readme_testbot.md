...
- **Install Nginx**  
  ...
  - **Setting Up Server Blocks**
    ...
    ```
    mkdir -p /var/www/testbot.1039835-ch37929.tmweb.ru/html;
    chown -R $USER:$USER /var/www/testbot.1039835-ch37929.tmweb.ru/html;
    chmod -R 755 /var/www/testbot.1039835-ch37929.tmweb.ru;
    ```
    
    - *index.html*
      ```
      nano /var/www/testbot.1039835-ch37929.tmweb.ru/html/index.html
      ```
      ```
      <html>
          <head>
              <title>Welcome to testbot.1039835-ch37929.tmweb.ru!</title>
          </head>
          <body>
              <h1>Success!  The testbot.1039835-ch37929.tmweb.ru server block is working!</h1>
          </body>
      </html>
      ```
      
    - *testbot.1039835-ch37929.tmweb.ru*

      ```
      nano /etc/nginx/sites-available/testbot.1039835-ch37929.tmweb.ru
      ```
      ```
      server {
              listen 80;
              ...
              root /var/www/testbot.1039835-ch37929.tmweb.ru/html;
              index index.html index.htm index.nginx-debian.html;

              server_name testbot.1039835-ch37929.tmweb.ru www.testbot.1039835-ch37929.tmweb.ru;
      ...
      ```
    ```
    ln -s /etc/nginx/sites-available/testbot.1039835-ch37929.tmweb.ru /etc/nginx/sites-enabled/;
    ```
    ```
    ...
    ```
    ```
    open in web browser on local machine: http://testbot.1039835-ch37929.tmweb.ru
    ```
...
- **Secure Nginx with Let's Encrypt**
  ...
  ```
  ```
  sudo certbot --nginx -d testbot.1039835-ch37929.tmweb.ru -d www.testbot.1039835-ch37929.tmweb.ru;
