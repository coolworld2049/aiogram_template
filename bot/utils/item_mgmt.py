...
from bot.keyboards.employees.manager.manager_kb import itemManagerModel_manager, manager_panel_ADD_item_func, \
    manager_panel_UPDATE_item_func, manager_panel_DELETE_item_func
from bot.states.ItemMgmtStates import ItemMgmtStates
from bot.strings.locale import items_mgmt_action_ADD_TEXT_pre, items_mgmt_action_DELETE_TEXT_pre, \
