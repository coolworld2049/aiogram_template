...
from answer_blanks.lang import registration_menu_TEXT, main_menu_TEXT, account_menu_message_IK_TEXT, navigation_menu_TEXT, \
...
from utils.chat_mgmt import save_message, _delete_message, get_last_message
