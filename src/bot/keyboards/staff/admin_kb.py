...
async def post_user_mgmt_message_IK_admin(user_id: int):
    await delete_previous_messages(user_id)
...
itemManagerModel_admin = ItemManagerModel(pre_admin_panel_message_IK, post_user_mgmt_message_IK_admin)
